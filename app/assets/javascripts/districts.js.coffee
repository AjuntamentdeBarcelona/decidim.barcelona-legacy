...
App.Districts =
  ...
  initialize: ->
    this.form = $('.new_proposal, .edit_proposal, .new_meeting, .edit_meeting, .new_action_plan, .edit_action_plan')
    this.districtSelect = this.form.find('#proposal_district, #meeting_district, #action_plan_district')
